...
class ContainerFactoryBoostSharedPtrVectorTest : public Test
{
  protected:
    using VectorContainer = std::vector<boost::shared_ptr<Base>>;
...
TEST_F( ContainerFactoryBoostSharedPtrVectorTest, add_one_base_element )
{
  container_factory::factory<Base>( destinationContainer );
...
TEST_F( ContainerFactoryBoostSharedPtrVectorTest, add_two_base_elements )
{
  container_factory::factory<Base, Base>( destinationContainer );
...
{
  protected:
    using VectorContainer = std::vector<std::unique_ptr<Base>>;
...
TEST_F( ContainerFactoryUniquePtrVectorTest, add_one_base_element )
{
  container_factory::factory<Base>( destinationContainer );
...
TEST_F( ContainerFactoryUniquePtrVectorTest, add_two_base_elements )
{
  container_factory::factory<Base, Base>( destinationContainer );
